...
const KeyVisual = (props: KeyVisualProps) => {
  return (
    <Main>
      ...
      <p>{props.text}</p>
      <Link to="/consoles">
        <Button color="primary" text="Consoles" icon="none" size="m" width={128} />
      </Link>
      <Link to="/projects">
        <Button color="outline" text="Projects" icon="none" size="m" width={128} />
      </Link>
      <GitHubButton url="https://github.com/StonedModder" />
    </Main>
  );
};
