...
export default createGlobalStyle`
    ...
    .__react_component_tooltip {
        background-color: ${Colors.bgColorLv3} !important;
        color: ${Colors.elementColorDefault} !important;
        border: 1px solid ${Colors.borderColorLv1} !important;
    }

    .__react_component_tooltip.place-top:after {
        border-top-color: ${Colors.bgColorLv3} !important;
    }

    .__react_component_tooltip.place-right:after {
        border-right-color: ${Colors.bgColorLv3} !important;
    }

    .__react_component_tooltip.place-bottom:after {
        border-bottom-color: ${Colors.bgColorLv3} !important;
    }

    .__react_component_tooltip.place-left:after {
        border-left-color: ${Colors.bgColorLv3} !important;
    }
